...
public final class DynamicView extends ModelView {
    ...
    DynamicView(Model model, String deploymentEnvironment, String key, String description) {
        super(null, key, description);
    ...
    public RelationshipView add(@Nonnull StaticStructureElementInstance source, String description, @Nonnull StaticStructureElementInstance destination) {
        RelationshipView relationshipView = addRelationshipViaElements(source, description, "", destination);

        DeploymentNode parent = (DeploymentNode)source.getParent();
        while (parent != null) {
        ...
        parent = (DeploymentNode)destination.getParent();
        while (parent != null) {
            addElement(parent, true);
            parent = (DeploymentNode)parent.getParent();
        }
