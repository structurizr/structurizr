...
public final class ViewSet {
    ...
    /**
     * Creates a dynamic view of the static model.
     *
     * @param key           the key for the view (must be unique)
    ...
    /**
     * Creates a dynamic view of the static model, where the scope is the specified software system.
    ...
    /**
     * Creates a dynamic view of the static model, where the scope is the specified container.
     * The following elements can be added to the resulting view:
     *
     * <ul>
     * <li>People</li>
    ...
    /**
     * Creates a dynamic view of the deployment model.
     *
     * @param key           the key for the view (must be unique)
     * @param description   a description of the view
     * @return              a DynamicView object
     * @throws              IllegalArgumentException if the key is not unique
     */
    public DynamicView createDynamicViewForDeploymentEnvironment(String deploymentEnvironment, String key, String description) {
        boolean keyIsAutomaticallyGenerated = false;
        ...
        DynamicView view = new DynamicView(model, deploymentEnvironment, key, description);
        view.setGeneratedKey(keyIsAutomaticallyGenerated);
        view.setOrder(getNextOrder());
        view.setViewSet(this);
        dynamicViews.add(view);
