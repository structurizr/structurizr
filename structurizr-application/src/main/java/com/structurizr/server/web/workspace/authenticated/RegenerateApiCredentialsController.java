...
import com.structurizr.server.web.Messages;
...
public class RegenerateApiCredentialsController extends AbstractWorkspaceController {
    ...
    public String regenerateApiCredentials(
        ...
        if (permissions.contains(Permission.Admin)) {
            String apiKey = workspaceMetadata.regenerateApiKey();
            workspaceComponent.putWorkspaceMetadata(workspaceMetadata);

            Messages messages = new Messages();
            messages.addSuccessMessage("API key: " + apiKey + "<div class=\"smaller\">(please make a note of this because you won't be able to see it again)</div>");
