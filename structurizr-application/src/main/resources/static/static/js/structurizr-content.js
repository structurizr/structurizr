...
structurizr.ui.ContentRenderer = function(workspace, host, urlPrefix, safeMode) {
    ...
    function renderEmbeddedDiagram(diagramIdentifier) {
        ...
        if (view) {
            ...
            var embedUrl = '/embed' + '?workspace=' + workspace.id + '&view=' + encodeURIComponent(diagramIdentifier) + '&perspective=' + encodeURIComponent(perspective) + '&type=' + type + '&urlPrefix=' + urlPrefix;
            if (branch) {
